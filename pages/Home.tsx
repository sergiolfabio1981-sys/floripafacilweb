...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* BRAND INTRODUCTION CON IA Y WHATSAPP */}
          ...
          <div className="bg-white rounded-[3rem] shadow-xl p-8 md:p-12 border border-gray-100 flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="text-center md:text-left flex-1">
                  ...
                  <p className="text-gray-500 text-lg leading-relaxed mb-8 font-medium">
                    En <span className="text-green-600 font-bold">Floripa Fácil</span>, combinamos la mejor tecnología con calidez humana. Consultá ahora con <span className="text-lime-600 font-bold">Flori</span> (nuestra asistente inteligente) para armar tu plan, o hablá directamente con un asesor por WhatsApp para cerrar tu reserva.
                  </p>
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                      ...
                      <button 
                        onClick={() => {
                          const botButton = document.querySelector('button[aria-label="Abrir chat"]') as HTMLButtonElement;
